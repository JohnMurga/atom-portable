...
IF NOT EXIST ".\\downloads\\go.zip" (
    %WGET% "https://dl.google.com/go/go1.11.windows-amd64.zip" ".\\downloads\\go.zip"
) else (
...
%PACK% .\packages\AtomPortable-Part4-Go-1.11-64bit.7z -r .\packages\go .\packages\_home -x!atom\Data -x!_home\.vimrc
...
%PACK% .\packages\AtomPortable-Part4-Go-1.11-64bit.7z -r .\packages\_tmp\atom
