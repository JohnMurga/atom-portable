...
IF NOT EXIST ".\\downloads\\go.zip" (
    %WGET% "https://storage.googleapis.com/golang/go1.9.3.windows-amd64.zip" ".\\downloads\\go.zip"
) else (
...
%PACK% .\packages\AtomPortable-Part4-Go-1.9.3-64bit.7z -r .\packages\go .\packages\_home -x!atom\Data -x!_home\.vimrc -x!_home\.cargo
...
%PACK% .\packages\AtomPortable-Part4-Go-1.9.3-64bit.7z -r .\packages\_tmp\atom
