...
IF NOT EXIST ".\\downloads\\go.zip" (
    %WGET% "https://storage.googleapis.com/golang/go1.8.3.windows-amd64.zip" ".\\downloads\\go.zip"
) else (
...
%PACK% .\packages\AtomPortable-Part4-Go-1.8.3-64bit.7z -r .\packages\go .\packages\_home -x!atom\Data -x!_home\.vimrc
...
%PACK% .\packages\AtomPortable-Part4-Go-1.8.3-64bit.7z -r .\packages\_tmp\atom
