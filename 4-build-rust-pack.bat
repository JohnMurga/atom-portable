...
IF NOT EXIST ".\\downloads\\rust.msi" (
    %WGET% "https://static.rust-lang.org/dist/rust-1.22.1-i686-pc-windows-gnu.msi" ".\\downloads\\rust.msi"
) else (
...
%PACK% .\packages\AtomPortable-Part3-Rust-1.22.1.7z -r .\packages\rust
