...
IF NOT EXIST ".\\downloads\\jdk.zip" (
    %WGET% "https://github.com/ojdkbuild/ojdkbuild/releases/download/1.8.0.161-1/java-1.8.0-openjdk-1.8.0.161-1.b14.ojdkbuild.windows.x86.zip" ".\\downloads\\jdk.zip"
) else (
