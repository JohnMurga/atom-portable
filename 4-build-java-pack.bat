...
IF NOT EXIST ".\\downloads\\jdk.zip" (
    %WGET% "https://github.com/ojdkbuild/ojdkbuild/releases/download/1.8.0.131-1/java-1.8.0-openjdk-1.8.0.131-1.b11.ojdkbuild.windows.x86.zip" ".\\downloads\\jdk.zip"
) else (
