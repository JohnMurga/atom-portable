...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v16.06.19/ConEmuPack.160619.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.9.0-beta0/atom-windows.zip" ".\\downloads\\atom-windows.zip"
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.9.0.windows.1/PortableGit-2.9.0-32-bit.7z.exe" "downloads\\PortableGit.7z"
