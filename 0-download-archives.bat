...
%WGET% "http://ftp.nara.wide.ad.jp/pub/X11/GNOME/binaries/win32/meld/3.18/Meld-3.18.3-win32.msi" ".\\downloads\\Meld.msi"
...
%WGET% "https://github.com/atom/atom/releases/download/v1.34.0-beta1/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
