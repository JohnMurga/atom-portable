...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v17.12.26/ConEmuPack.171226.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.24.0-beta2/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.16.0-rc1.windows.1/PortableGit-2.16.0.rc1.windows.1-32-bit.7z.exe" "downloads\\PortableGit.7z"
