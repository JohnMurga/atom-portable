...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v15.12.24/ConEmuPack.151224.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.4.0-beta3/atom-windows.zip" ".\\downloads\\atom-windows.zip"
