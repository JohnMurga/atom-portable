...
%WGET% "http://repo.msys2.org/msys/i686/libsqlite-3.18.0.0-1-i686.pkg.tar.xz" ".\\downloads\\Sqlite-lib.tar.xz"
...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v17.06.22/ConEmuPack.170622.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.19.0-beta1/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.13.1.windows.2/PortableGit-2.13.1.2-32-bit.7z.exe" "downloads\\PortableGit.7z"
