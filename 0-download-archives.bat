...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v15.11.09/ConEmuPack.151109.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.2.2/atom-windows.zip" ".\\downloads\\atom-windows.zip"
