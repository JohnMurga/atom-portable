...
%WGET% "https://www.fossil-scm.org/fossil/uv/fossil-w32-2.1.zip" ".\\downloads\\Fossil.zip"
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v17.03.16/ConEmuPack.170316.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.16.0-beta0/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
