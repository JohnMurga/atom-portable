...
%WGET% "https://nodejs.org/dist/v6.5.0/node-v6.5.0-x86.msi" ".\\downloads\\Node.msi"
...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v16.09.13/ConEmuPack.160913.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.11.0-beta5/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
