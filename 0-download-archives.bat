...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v17.03.26/ConEmuPack.170326.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.16.0-beta0/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.12.2.windows.1/PortableGit-2.12.2-32-bit.7z.exe" "downloads\\PortableGit.7z"
