...
%WGET% "http://www.7-zip.org/a/7z1600.msi" ".\\downloads\\7Zip.msi"
...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v16.05.22/ConEmuPack.160522.7z" ".\\downloads\\ConEmu.7z"
