...
%WGET% "http://www.7-zip.org/a/7z1802.msi" ".\\downloads\\7Zip.msi"
...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v18.02.06/ConEmuPack.180206.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.25.0-beta2/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
