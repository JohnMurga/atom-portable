...
%WGET% "https://imagemagick.org/download/binaries/ImageMagick-i686-pc-mingw32.tar.gz" ".\\downloads\\ImageMagick.tar.gz"
...
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.26.0-rc1.windows.1/PortableGit-2.26.0-rc1-32-bit.7z.exe" "downloads\\PortableGit.7z"
