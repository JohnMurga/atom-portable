...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v16.02.22/ConEmuPack.160222.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.6.0-beta6/atom-windows.zip" ".\\downloads\\atom-windows.zip"
