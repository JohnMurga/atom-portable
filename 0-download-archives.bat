...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v17.11.17/ConEmuPack.171117.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.23.0-beta1/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.15.0.windows.1/PortableGit-2.15.0-32-bit.7z.exe" "downloads\\PortableGit.7z"
