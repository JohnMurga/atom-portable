...
%WGET% "http://repo.msys2.org/msys/i686/sqlite-3.19.3.0-1-i686.pkg.tar.xz" ".\\downloads\\Sqlite.tar.xz"
%WGET% "http://repo.msys2.org/msys/i686/libsqlite-3.19.3.0-1-i686.pkg.tar.xz" ".\\downloads\\libsqlite.tar.xz"
...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v17.08.19/ConEmuPack.170819.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.19.3/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
%WGET% "https://github.com/git-for-windows/git/releases/download/v2.14.1.windows.1/PortableGit-2.14.1-32-bit.7z.exe" "downloads\\PortableGit.7z"
