...
%WGET% "https://github.com/Maximus5/ConEmu/releases/download/v16.10.09a/ConEmuPack.161009a.7z" ".\\downloads\\ConEmu.7z"
%WGET% "https://github.com/atom/atom/releases/download/v1.12.0-beta3/atom-windows.zip" ".\\downloads\\Atom-windows.zip"
